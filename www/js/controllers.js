...
.controller('ContactCtrl', function($scope) {
  ...
  .controller('CotacaoCtrl', function($scope) {
  
    $scope.SendCotacao = function() {

      $scope.takePicture(this.camera.PictureSourceType.CAMERA);
    //  alert("falhou");
...
.controller('HomeCtrl', function($scope, $rootScope, $state, $ionicLoading, $stateParams, PostService) {
    
  $scope.category = {};
  $scope.category.id = 28;//$stateParams.categoryId;
 ...
 //     $scope.posts = $scope.posts.concat(new_posts);
  ...
  $scope.CallUs = function(){
         ...
         window.location.href = 'tel:02122665997';
...
.controller('PostArtigosCtrl', function($scope, $rootScope, $state, $ionicLoading, $stateParams, PostService) {
  
    $scope.category = {};
    $scope.category.id = 27; //$stateParams.categoryId;
    $scope.category.title = $stateParams.categoryTitle;
